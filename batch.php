            ...
            <div class="collapse" id="icons">
              <ul class="nav flex-column sub-menu">
			   <li class="nav-item"> <a class="nav-link" href="class.php">add class</a></li>
                <li class="nav-item"> <a class="nav-link" href="">add batch</a></li>
            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="forms-sample" action="dosaaving.php" method="post">
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputUsername1" placeholder="ex:2022_std1" name="bch_name" required>
                    </div>
                    <div class="form-group">
                 ...
                 <button type="submit" name="addbatch" class="btn btn-primary mr-2" value="addbatch">Add</button>

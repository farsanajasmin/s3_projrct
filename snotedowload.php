...
<body>
  ...
  $f_id = $_GET['f_id'];
                ...
                ?>
				<P><?PHP ECHO "DOWLOAD FROM HERE";?>
                <a href="uploads/<?php echo $row['name']; ?>" download="<?php echo $row['name']; ?>" class="download_link" ><?php echo $row['name']; ?></a>
                <?php
   ...
   <?php foreach ($files as $file): ?>
    <tr>
	 ...
	 <?php $sql="SELECT * FROM tbl_subjects where sbid= '$sbid'";
      ...
      <td><a href="snotedowload.php?f_id=<?php echo $file['f_id'] ?>">Download</a></td>
    </tr>
  <?php endforeach;?>

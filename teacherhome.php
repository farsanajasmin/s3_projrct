          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="pages/samples/register.html"> view 
				</a></li>
				 <li class="nav-item"> <a class="nav-link" href="pages/samples/register.html"> verify marks</a></li>
				  <li class="nav-item"> <a class="nav-link" href="pages/samples/register.html"> exam results</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">

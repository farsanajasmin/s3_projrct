...
<body>
        ...
        <!-- Sign up form -->
           ...
           <div class="col-lg-10 stretch-card">
            ...
            <tr>
   <td colspan="10" align="center"><h3><b>Teacher List</b></h3></td>
   </tr> 
     <tr class="table-info">
	...
	<?php
	$sql="SELECT stu_id,name,email FROM tbl_studentregister WHERE status!='1'";
  ...
  <tr>
    ...
    <td><?=$name?></td>
	 <td><?=$email?></td>
	 <td>
				<button  type="button" class="btn btn-primary btn-xs dt-edit"> <a href="tupdate.php?id=<?php echo $row['stu_id'];?>"> 
					<span class="glyphicon glyphicon-pencil" aria-hidden="true">update</span></a>
				</button>
				
					<button  type="button"class="btn btn-danger btn-xs dt-delete"> <a href="delete.php?id=<?php echo $row['stu_id'];?>"> 
					<span class="glyphicon glyphicon-pencil" aria-hidden="true">delete</span></a>
				</button>
			</td>

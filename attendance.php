  ...
  <div class="content">
    ...
    <form action="" method="post" class="form-horizontal col-md-15 col-md-offset-10">
         ...
         <div class="form-group">
                      <label for="exampleInputUsername1">Batch</label><br><br><br><br>
					  <div class="col-sm-25">
   ...
   <form action="" method="post" class="form-horizontal col-md-40 col-md-offset-30">
    <div class="form-group">
                      <label for="exampleInputEmail1"> Subjects</label><br><br><br><br>
                    <!--  <input type="text" class="form-control" id="exampleInputEmail1" placeholder="class" name="class">
					-->
					<div class="col-sm-40" class="form-control">
   ...
   <?php
    ...
    if(isset($_POST['bch_id'])){
     ...
     $batch = $_POST['bch_id'];
      ...
      $sql ="select * from tbl_studentregister where tbl_studentregister.bch_id = '$batch' order by bch_id asc";
  $result=mysqli_query($db , $sql);
	...
	$hour=$_POST['hour'];
	 ...
	 foreach ($_POST['st_status'] as $i => $st_status) {
        ...
        $sql7="SELECT stu_id FROM tbl_studentregister where tbl_studentregister.regno='$stat_id'";
				 ...
				 $sql8="SELECT cst_id FROM tbl_cst where tbl_cst.bch_id='$batch' AND tbl_cst.sbid='$sbid' ";
			
                    $result2=mysqli_query($db , $sql8);

        ...
        <!--  <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="charts">
              <ul class="nav flex-column sub-menu">
				...
				<li class="nav-item"> <a class="nav-link" href="">attendance Detailes</a></li>
				<!--<li class="nav-item"> <a class="nav-link" href="pages/charts/chartjs.html">view attendance</a></li>-->
			   <!-- <li class="nav-item"> <a class="nav-link" href="studsaerch.php">search attendance</a></li>-->
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="">upload notes</a></li>
	            <li class="nav-item"> <a class="">view notes</a></li>
				 <li class="nav-item"> <a class="">search notes</a></li
              </ul>
            </div>
          </li>
...
<head>
 ...
 <div class="col-lg-8 mx-auto">
            <div class="auth-form-light text-right py-1 px-2 px-sm-1">
              ...
              <form class="forms-sample" action="" method="post">
                     <div class="form-group">
                      <label for="exampleInputEmail1">batch</label><br><br><br>
   ...
   <td colspan="10" align="center"><h3><b>attendance report</b></h3></td>
	...
	$sql10 ="select * from tbl_cst where tbl_cst.bch_id = '$batch' AND tbl_cst.sbid = '$sbid'";

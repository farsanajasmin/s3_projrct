        ...
        <!--  <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              ...
              <!--  <li class="nav-item"><a class="nav-link" href="pages/forms/basic_elements.html">student List</a></li>-->
				<li class="nav-item"><a class="nav-link" href="pages/forms/basic_elements.html">student Detailes</a></li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="charts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="">take attendance</a></li>
          ...
          <li class="nav-item">
           <a class="nav-link" data-toggle="collapse" href="#icons" aria-expanded="false" aria-controls="icons">
            ...
            <div class="collapse" id="icons">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="">shedule classes</a></li>
				<li class="nav-item"> <a class="">view shedules</a></li>
...
<body>
        ...
        <section class="signup">
		   ...
		   <div class="form-group">
					  <label for="">subjects</label><br><br><br>
                    ...
                    ?>
						   ...
						   <div class="form-group">
						   <label for="">batch</label><br><br><br>
						   <div class="col-sm-16">
                    ...
                    ?>
                     ...
                     <div class="form-group">
                      <label for=""> Teacher</label><br><br><br>
                    <!--  <input type="text" class="form-control" id="exampleInputEmail1" placeholder="class" name="class">
					-->
					<div class="col-sm-15">
                    ...
                    ?>
					 ...
					 <div class="form-group">
                      <label for=""> start time</label><br><br><br>
                    <!--  <input type="text" class="form-control" id="exampleInputEmail1" placeholder="class" name="class">
					-->
					<div class="col-sm-15">
                            <select class="form-control" id="id" name="S_id">
                               <?php
                    $sql="SELECT id,start_time FROM tbl_timer";
		...
		
                    {
                        //if($type==$row['mtype_id'])
                            //echo '<option value="'.$row['mtype_id'].'" selected="selected">'.$row['m_type'].'</option>';
                        //else
                             echo '<option value="'.$row['id'].'" >'.$row['start_time'].'</option>';
                    }
                    ?>
                            </select>
                          </div>
					 ...
					 <div class="form-group">
                      <label for=""> End time</label><br><br><br>
                    <!--  <input type="text" class="form-control" id="exampleInputEmail1" placeholder="class" name="class">
					-->
					<div class="col-sm-15">
                            <select class="form-control" id="id" name="E_id">
                               <?php
                    $sql="SELECT id,end_time FROM tbl_timer";
		...
		
                    {
                        //if($type==$row['mtype_id'])
                            //echo '<option value="'.$row['mtype_id'].'" selected="selected">'.$row['m_type'].'</option>';
                        //else
                             echo '<option value="'.$row['id'].'" >'.$row['end_time'].'</option>';
                    }
                    ?>
                            </select>
                          </div>
					...
					<div class="form-group">
                      <label for="exampleInputUsername1">Meet</label><br><br><br>
...
{
    $tbl_shedule = getPosts();
	

		$existing_Query = "SELECT * from `tbl_shedule` WHERE  `course`='$tbl_shedule[1]' AND
		 `start_time`='$tbl_shedule[4]' AND `end_time`='$tbl_shedule[5]' AND `date`='$tbl_shedule[6]'";
		$existing_Result = mysqli_query($db, $existing_Query);
 ...
 $insert_Query = "INSERT INTO `tbl_shedule`(`faculty`, `course`, `subject`, `meet`, `start_time`, `end_time`,`date`) VALUES ('$tbl_shedule[0]','$tbl_shedule[1]', '$tbl_shedule[2]', '$tbl_shedule[3]', '$tbl_shedule[4]', '$tbl_shedule[5]','$tbl_shedule[6]')";

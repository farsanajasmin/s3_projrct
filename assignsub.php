...
<body>
  <div class="container-scroller">
			   ...
			   <li class="nav-item"> <a class="nav-link" href="class.php">add class</a></li>
                <li class="nav-item"> <a class="nav-link" href="Batch.php">add batch</a></li>
				 <li class="nav-item"> <a class="nav-link" href="addsub.php">add subjects</a></li>
				  <li class="nav-item"> <a class="nav-link" href="">assign subjects</a></li>
            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="forms-sample" action="dosaaving.php" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" id="exampleInputPassword1" placeholder="creation date:dd/mm/yyy" name="date" required>
                    </div>
                    <div class="form-group">
                 ...
                 <button type="submit" name="addcst" class="btn btn-primary mr-2" value="addbatch">Add</button>
   ...
   <td colspan="10" align="center"><h3><b>Assign Teacher</b></h3></td>
	...
	<?php
	$sql="SELECT tbl_batch.bch_name,tregister.name,tbl_subjects.sub_name,tbl_cst.date FROM tbl_cst  LEFT JOIN tbl_batch  ON tbl_cst.bch_id=tbl_batch.bch_id  LEFT JOIN tregister ON tbl_cst.t_id=tregister.t_id  LEFT JOIN tbl_subjects  ON tbl_cst.sbid=tbl_subjects.sbid   ";
